...
WebUiBuiltInKeywords.click(findTestObject('Reports/Advisor/lnk_Consolidated Statement of Investment'), FailureHandling.STOP_ON_FAILURE)

CustomKeywords.'input.Date.fromText'(findTestObject('Reports/Advisor/txt_FromDate'), GlobalVariable.TestValues['DateFrom'])

CustomKeywords.'input.Date.fromText'(findTestObject('Reports/Advisor/txt_ToDate'), GlobalVariable.TestValues['DateTo'])
