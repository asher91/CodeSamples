...
WebUiBuiltInKeywords.click(findTestObject('Reports/Advisor/lnk_IT-IB 3b Tax Statement'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByIndex(findTestObject('Reports/Advisor/sel_AdvisorList'), GlobalVariable.TestValues['AdvisorIndex'], 
